    ...
    <section className="bg-background py-16">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mb-8 text-text-light">
            Taylored Instruction is a small business born in Vancouver, WA,
            owned and operated by Evan Taylor. Evan has been swimming since a
            young age, and began teaching swimming lessons and lifeguarding at
            age 15. He discovered his passion for teaching health and safety
            classes, and became an American Red Cross instructor at age 17.
          </p>
