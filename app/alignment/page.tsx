...
export const metadata: Metadata = {
  ...
  description:
    "Align with Taylored Instruction, an American Red Cross Licensed Training Provider and AHA Training Site in Vancouver, WA. Enhance your CPR, First Aid, or Lifeguard training courses with our support.",
  keywords: [
