...
export const metadata: Metadata = {
  title:
    "First Aid/CPR/AED Certification Course | Vancouver WA - Taylored Instruction",
  description:
    "Learn to respond to cardiac, breathing, and first aid emergencies with the American Red Cross First Aid/CPR/AED course at Taylored Instruction in Vancouver, WA. Gain life-saving skills.",
  keywords: [
...
const FirstAidCprAedPage: React.FC = () => {
  return <FirstAidCprAedPageContent />;
};
