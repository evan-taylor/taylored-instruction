...
export const metadata: Metadata = {
  title:
    "Red Cross First Aid/CPR/AED Instructor Course | Vancouver WA - Taylored Instruction",
  description:
    "Become a certified American Red Cross First Aid/CPR/AED Instructor with Taylored Instruction in Vancouver, WA. Train to teach others lifesaving skills.", // From <meta name="description">
  keywords: [
  ...
  openGraph: {
    title:
      "Red Cross First Aid/CPR/AED Instructor Course | Vancouver WA - Taylored Instruction", // From og:title
    description:
      "Become a certified American Red Cross First Aid/CPR/AED Instructor with Taylored Instruction in Vancouver, WA. Train to teach others lifesaving skills.", // From og:description
  ...
  twitter: {
    ...
    title:
      "Red Cross First Aid/CPR/AED Instructor Course | Vancouver WA - Taylored Instruction", // From twitter:title, corrected for consistency
    description:
      "Become a certified American Red Cross First Aid/CPR/AED Instructor with Taylored Instruction in Vancouver, WA. Train to teach others lifesaving skills.", // From twitter:description, corrected for consistency
