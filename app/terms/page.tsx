    ...
    <>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p>By providing your phone number and agreeing to receive texts, you consent to receive promotional and account-related SMS messages from Taylored Instruction at 360-685-8199. Message frequency varies, but you can expect up to 4 messages per month. Message and data rates may apply. Consent is not a condition of purchase.</p>
