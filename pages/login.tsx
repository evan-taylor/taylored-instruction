...
const LoginPage: NextPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Head>
        <title>Instructor Login | Taylored Instruction</title>
        <meta
          name="description"
          content="Login portal for Taylored Instruction instructors. Access instructor resources, eCards, and more."
        />
      </Head>
      <Header />
      <main
